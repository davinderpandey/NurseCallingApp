package com.app.nursecalling.fragments
...
import com.app.nursecalling.activities.MainActivity
import com.app.nursecalling.commoners.AppUtils
import com.app.nursecalling.commoners.BaseFragment
import com.app.nursecalling.commoners.PrefData
...
class LoginFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        val successfulIcon = AppUtils.setDrawable(
            requireActivity(),
            Ionicons.Icon.ion_checkmark_round,
            R.color.white,
            25
        )
        signupSuccessful = AppUtils.drawableToBitmap(successfulIcon)
